...
public class Product {
    ...
    public String name;
    public HashMap<ArrayList<Integer>, Double> records = new HashMap<ArrayList<Integer>, Double>();
     ...
     * @return
     */
    public HashMap<ArrayList<Integer>, Double> getRecords() {
        return records;
    }
     ...
     * @return
     */
    public String ProductToString(int originYear, int finalYear, int n) {
